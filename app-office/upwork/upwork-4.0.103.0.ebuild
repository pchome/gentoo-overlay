...
SRC_URI="amd64? ( http://updates.team.odesk.com/binaries/v4_0_103_0_c83b8ec3fe3d726/${PN}_x86_64.rpm -> ${P}_x86_64.rpm )
		 x86? ( http://updates.team.odesk.com/binaries/v4_0_103_0_c83b8ec3fe3d726/${PN}_i386.rpm -> ${P}_i386.rpm )
"
LICENSE="ODESK"
SLOT="0"
KEYWORDS="~amd64 ~x86"
